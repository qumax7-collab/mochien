...
규칙:
1. 검증된 교과서 원리에 한함. principle 밖 확장·새 주장·예측·투자 권유·시세 예측 금지.
2. 경제 입문자 기준. 전문 용어는 쉽게 설명. 뉴스는 원리의 '입구' — 인과 메커니즘 설명까지.
   구어 해설체(~습니다/~죠/~이에요) 통일. 명사 종결("늘어남") 및 메모체 금지.
3. 데이터 근거 블록 수치만 인용. 블록 밖 수치 생성 절대 금지.
...
5. 기사 수치·고유명사 인용 시 [출처: 기사1] 또는 [출처: 기사2] 표기.\
"""
